...
const nextConfig = {
  ...
  // Fix Turbopack workspace root detection in Next.js 16.
  // Using next.config.js (CJS) ensures __dirname is available before
  // Turbopack initialises, so the root is set before the workspace scan.
  turbopack: {
    root: __dirname,
  },
