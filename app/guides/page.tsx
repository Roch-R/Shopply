          ...
          <div className="grid">
            {guidesData.map((guide) => (
              <Link href={`/guides/${guide.slug}`} key={guide.slug} style={{textDecoration:'none'}}>
                <div className="card" style={{padding:0,overflow:'hidden',cursor:'pointer',border:'1px solid #f1f5f9',height:'100%',display:'flex',flexDirection:'column'}}>
                  <div style={{height:'160px',background:'linear-gradient(135deg, #f8fafc, #f1f5f9)',display:'flex',alignItems:'center',justifyContent:'center',flexShrink:0}}>
                    {guide.icon}
                  </div>
                  <div style={{padding:'24px',display:'flex',flexDirection:'column',flex:1}}>
                    ...
                    <span style={{color:'#64748b',fontSize:'14px',fontWeight:500,marginTop:'auto'}}>Read Guide &rarr;</span>
                  </div>
                </div>
              </Link>
            ))}
